        ...
        return new Promise(resolve => {
            ...
            process.on("error", (error) => {
                if ("ENOENT" === error.code) {
                    ...
                    this.session.connection.window.showWarningMessage(`Double check your path or try configuring "imandra.path.esy" under "User Settings". Do you need to "npm install -g esy"? Alternatively, disable "esy" in "reason.diagnostics.tools"`);
                }
                resolve("");
            });
