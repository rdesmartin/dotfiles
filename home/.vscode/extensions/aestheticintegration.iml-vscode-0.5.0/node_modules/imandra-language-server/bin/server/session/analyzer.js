...
class Analyzer {
    ...
    onDidChangeConfiguration() {
        ...
        this.refreshDebounced = lodash.debounce(this.refreshWithKind(LSP.TextDocumentSyncKind.Incremental), this.session.settings.imandra.debounce.linter, { trailing: true });
    }
    refreshWithKind(syncKind) {
        return (id) => __awaiter(this, void 0, void 0, function* () {
            const tools = new Set(this.session.settings.imandra.diagnostics.tools);
            if (tools.size < 1)
                return;
