        ...
        return new Promise(resolve => {
            ...
            process.on("error", (error) => {
                if ("ENOENT" === error.code) {
                    ...
                    this.session.connection.window.showWarningMessage(`Double check your path or try configuring "imandra.path.bsb" under "User Settings". Alternatively, disable "bsb" in "imandra.diagnostics.tools"`);
                }
                resolve("");
            });
