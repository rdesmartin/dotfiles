...
class Synchronizer {
    ...
    doFullSync(document, languageId, content) {
        return __awaiter(this, void 0, void 0, function* () {
            this.documents.set(document.uri, LSP.TextDocument.create(document.uri, languageId, document.version ? document.version : 0, content));
    ...
    doIncrementalSync(oldDocument, newDocument, change) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (null != newContent) {
                this.documents.set(newDocument.uri, LSP.TextDocument.create(oldDocument.uri, oldDocument.languageId, newDocument.version ? newDocument.version : 0, newContent));
            }
