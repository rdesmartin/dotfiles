...
const basis = require("./imandrabasis");
...
class Imandra {
    ...
    bindTermWith(...startBody) {
        return {
            patterns: [
                {
                    begin: alt(this.lastOps("!"), lastWords(Token.AND, Token.EXTERNAL, Token.LET, Token.METHOD, Token.VAL, Token.LEMMA, Token.AXIOM, Token.VERIFY, Token.THEOREM, Token.INSTANCE)),
                    ...
                    patterns: [
                        {
                            begin: alt(this.lastOps("!"), lastWords(Token.AND, Token.EXTERNAL, Token.LET, Token.LEMMA, Token.AXIOM, Token.VERIFY, Token.THEOREM, Token.METHOD, Token.VAL, Token.INSTANCE)),
    ...
    declTerm() {
        return {
            begin: seq(words(group(alt(capture(alt(Token.EXTERNAL, Token.VAL)), capture(Token.METHOD), capture(Token.LET), capture(Token.LEMMA), capture(Token.AXIOM), capture(Token.VERIFY), capture(Token.THEOREM), capture(Token.INSTANCE)))), capture(opt("!"))),
            end: this.declEndItem(),
            beginCaptures: {
    ...
    termVerifyTheoremLemma() {
        return {
            patterns: [
                {
                    match: alt(capture(Token.LEMMA), capture(Token.AXIOM), capture(Token.THEOREM), capture(Token.VERIFY), capture(Token.INSTANCE)),
                    captures: {
                        1: { name: Scope.TERM_LET() },
                    },
                    patterns: [include(this.bindTerm)],
...
exports.Imandra = Imandra;
exports.default = new Imandra().render();
//# sourceMappingURL=imandra.js.map